...
public class Wererat extends Beast {
	...
	//rat attacks
	public Attack attack_one(Player victim, int textlevel, Dice bite, String rat_index) {
	...
	public Attack attack_two(Player victim, int textlevel, Dice scratch, String rat_index) {
		...
		if(hitroll >= tohit || hitroll == 20) {
			...
			switch (textlevel) {
				...
				case 3:
					if(rat_index.compareToIgnoreCase("void") == 0) {
						dialogue = ("The rat's claws scratch "+victim.getname()+" for "+damage+" points!");
					}
					else dialogue = ("The rat's claws ("+rat_index+") scratch "+victim.getname()+" for "+damage+" points!");
					break;
				default:
					System.out.println("Wha?");
			}				
			...
			switch (textlevel) {
				...
				case 3:
					if(rat_index.compareToIgnoreCase("void") == 0) {
						dialogue = ("The rat swipes at "+victim.getname()+", but misses!");
					}
					else dialogue = ("The rat ("+rat_index+") swipes at "+victim.getname()+", but misses!");
					break;
				default:
					System.out.println("Wha?");
			}
